...
namespace UnityEditor
{
	internal class UVFreePBRShaderGUI : ShaderGUI
	{
		...
		private static class Styles
		{
            ...
            public static GUIContent transparencyText = new GUIContent( "Transparency", "Yeehaw!" );
            public static GUIContent cutoutText = new GUIContent( "Cutout", "Yeehaw!" );
        ...
        MaterialProperty cutoutThreshold = null;
		...
		public void FindProperties (MaterialProperty[] props)
		{
            ...
            cutoutThreshold = FindProperty( "_CutoutTreshold", props, false );
		...
		public void ShaderPropertiesGUI (Material material)
		{
			...
			EditorGUI.BeginChangeCheck();
			{
                ...
                {
                    m_MaterialEditor.RangeProperty( transparency, "Transparency" );
                }

                if( cutoutThreshold != null )
                {
                    m_MaterialEditor.RangeProperty( cutoutThreshold, "Cutout" );
                }
