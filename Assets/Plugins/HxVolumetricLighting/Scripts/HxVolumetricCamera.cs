...
/*#if HXVR
        if( Mycamera.stereoTargetEye == StereoTargetEyeMask.Both && Application.isPlaying && UnityEngine.XR.XRSettings.enabled && XRUtil.isPresent() )
        {
            return true;
        }
#endif*/
    ...
    {
/*#if HXVR
        if( Mycamera.stereoTargetEye != StereoTargetEyeMask.None && Application.isPlaying && UnityEngine.XR.XRSettings.enabled && XRUtil.isPresent() )
        {
